import logo from "../assets/logo-portfolio.png";  // Assure-toi que le chemin vers ton logo est correct
...
export default function Footer() {
  return (
    <footer id="footer-contact" className="bg-black text-white py-12 flex flex-col items-center">
      {/* Logo à la place du placeholder */}
      ...
      <p className="mt-4">Un projet de Sanjy BOOT JEROME - © 2024 Portfolio - Tous droits Réservés.</p>
    </footer>
  );
}
